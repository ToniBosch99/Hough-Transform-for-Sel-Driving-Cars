...
edgedFrame = edge(I_blurr, 'canny', thr);



%//////////////////////////////// 3. HOUGH TRANSFROM /////////////////////%
% --------- Find hough map
theta_vals = [-80:.5:-10, 10:.5:80]; % limit range of thetaas to find 
[H,theta,rho] = hough(edgedFrame, 'RhoResolution' ,0.5, 'Theta' ,theta_vals);
...
minLength = 7;
lines = houghlines(edgedFrame, theta, rho, P, 'FillGap' ,30, 'MinLength' ,minLength);
